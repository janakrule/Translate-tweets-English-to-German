<p >Test Application.<br />Built by Janak</p>
<form action="" method="post">
    <p>Enter statement in english: <input type='text' name='msg' placeholder="Your Message"></p>
    <input type="submit" >
</form>
...
try {
    ...
    echo "<p >Translation For <b>$inputStr</b></p>";
